...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmathdx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmathdx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libmathdx libmathdx-dev libmathdx-static libmathdx0
# for installing globally
pixi global install libmathdx libmathdx-dev libmathdx-static libmathdx0
```
...
It is possible to list all of the versions of `libmathdx` available on your platform:
...
```
pixi search libmathdx --channel conda-forge
```
